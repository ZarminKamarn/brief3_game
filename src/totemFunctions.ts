import {
  ...
  keys,
  levels,
  totemArrowOrientation,
  variables,
} from "./data.js";
import { getCoordAfterMove, moveElement, sleep } from "./gameLogicFunctions.js";
import {
  addGameListener,
  generateGridImage,
  removeGameListener,
...
export async function totemShoots(
  div: HTMLElement,
  posX: number,
  posY: number
) {
